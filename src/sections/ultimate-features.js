...
const data = [
  ...
  },
  {
    ...
    description: `This feature aids in determining the most economical path for sales representatives to cover their region. Route optimization software determines the quantity of resources needed to cover all routes in a streamlined manner for more face time than journey time, as well as the logistically most effective approach to cover retailers in a territory. ensuring that sales representatives can visit the most stores possible while getting enough face time with the retailers on a given day. Route optimization aids businesses in creating routes that take into account a range of variables, 
...
Regardless matter how effectively a corporation uses workflow automation technologies to address its business process-specific issues, uneven performance and misaligned team member activities result in significant daily revenue loss. In any team, 30% of members in the same region consistently reach their goals while others don't. There is a significant opportunity for
 about 40% of people to increase their output by 15% to 20%.`,
  },
  {
    ...
    Order maximization through sales automation enables FMCG firms to boost sales by cross-selling, up-selling, and the promotion of loyalty programs, schemes, and order suggestions, all of which are frequently overlooked by a portion of sales executives at the POS. Thus, the order maximization technique is essential for giving sales an extra boost through precise targeting. In order to guarantee efficient order maximization without backlogs,
