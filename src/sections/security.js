      ...
      <Container>
        <Box sx={styles.grid}>
          ...
          <SectionHeading
            ...
            description="Ghala Kuu is on top-notch security and surveillance, with a reliable 99.9% uptime. Secure database with encryption both at rest and end-to-end."
